...
Процедура ЗаписатьМатрицуВJSON(ЗаписьJSON, ИмяАтрибута, Матрица)
	...
	Для каждого СтрокаМатрицы Из Матрица Цикл
		ЗаписьJSON.ЗаписатьНачалоМассива();
		Для Значение Из СтрокаМатрицы Цикл
...
Процедура ЗаписатьЗначениеМатрицыйИзJSON(ЧтениеJSON, ИмяАтрибута, Матрица)
...
Процедура ЗаписатьЗначениеМассиваИзJSON(ЧтениеJSON, ИмяАтрибута, Массив)
...
Процедура ЗаписатьЗначениеПеременнойИзJSON(ЧтениеJSON, ИмяАтрибута, Переменная)
...
Процедура ПолучитьСостояние()
	...
	ЗаписатьЗначениеМатрицыйИзJSON(ЧтениеJSON, "A", A);
	ЗаписатьЗначениеМассиваИзJSON(ЧтениеJSON, "M", M);
	ЗаписатьЗначениеМассиваИзJSON(ЧтениеJSON, "L", L);
	ЗаписатьЗначениеПеременнойИзJSON(ЧтениеJSON, "X", X);
	ЗаписатьЗначениеПеременнойИзJSON(ЧтениеJSON, "Y", Y);
